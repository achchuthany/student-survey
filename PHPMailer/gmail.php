...
$mail->addReplyTo('no-replay@achchuthan.org', 'no-replay');

//Set the subject line
$mail->Subject = 'SLGTI - Survey Email Invitational';
...
$links = null;
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            $links = $links .'<a href="http://www.slgti.achchuthan.org/student-survey/student-survey.php?token=a5c2896e4eb2772661e2e27e724c6408" target="_blank">Graphic Design Survey - Semester 1 (2016/2017)</a>';
        }
    }
...
$mail->addAddress('info@achchuthan.org', 'John Doe');
...
<a href="http://www.slgti.achchuthan.org/student-survey/student-survey.php?token=a5c2896e4eb2772661e2e27e724c6408" target="_blank">Graphic Design Survey - Semester 1 (2016/2017)</a>
