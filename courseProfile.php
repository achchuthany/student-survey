        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h3>List of Modules for <?php if(isset($_GET['course'])) echo $_GET['course'].' <small>('.$_GET['id'].')</small>'; ?></h3>
                </div>
            </div>
        </div>
 <div class="row">
            <div class="col-md-12">        
                ...
                <span class="glyphicon glyphicon-plus-sign" aria-hidden="true" data-toggle="modal" data-target="#ADD-DEPARTMENT"></span> Add Module
                </button>  
            </div>
        </div>
